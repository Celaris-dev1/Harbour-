...
ALTER TABLE goals ADD COLUMN IF NOT EXISTS warrant_token TEXT NOT NULL DEFAULT '';
ALTER TABLE goals ADD COLUMN IF NOT EXISTS warrant_svid TEXT NOT NULL DEFAULT '';
